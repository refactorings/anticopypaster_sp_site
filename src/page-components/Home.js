...
function Home() {
  return (
    <div className='Home'>
        {/* TITLE */}
        <div>
            <h2 className="text-lg font-bold text-gray-900">AntiCopyPaster: Duplicate Code IntelliJ Plugin</h2>
        </div>

        {/* PROJECT INFORMATION */}
        <div className='SynopsisBlock'>
            <h2 className='font-bold'>Project Synopsis:</h2><br/>
        ...
        <div className='TimelineBlock'>
            <h3 className="font-bold">Project Timeline:</h3><br/>
            <div className='MetricsModelPlanBlock'>
            ...
            <div className='BackendMetricsModelBlock'>
                <p className="DocumentationLinkStyling">Backend Metrics Model</p>
            </div>
            <div className='FunctioningMetricsMenuBlock'>
                <p className='DocumentationLinkStyling'>Functioning Metrics Menu</p>
            </div>
        </div>
    </div>
  );
