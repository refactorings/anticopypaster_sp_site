        ...
        <div className="inline-flex">
            ...
            <div className='m-4 p-4 rounded'>
                ...
                <div className="flex-col m-2">
                    <div className=''>
                        <p className='font-medium leading-tight text-m m-4' href="https://docs.google.com/document/d/1eDYSmdQ1mk26TYgQa8wtxAfeu77ZFJJS7wr-kB5ctbw/edit?usp=sharing">Metrics Model Plan</p>
                    </div>
                    <div>
                        <p className="font-medium leading-tight text-m m-4">Backend Metrics Model</p>
                    </div>
                    <div>
                        <p className='font-medium leading-tight text-m m-4'>Functioning Metrics Menu</p>
                    </div>
                </div>
            </div>
        </div>
