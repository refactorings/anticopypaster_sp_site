    ...
    <div className='Home'>
        ...
        <div className="inline-flex">
            ...
            <div className='m-4 p-4 rounded'>
                <h3 className="font-medium leading-tight text-xl mt-0 mb-2 text-zinc-600">Project Timeline:</h3>
                <div className="flex-col">
                    <div className=''>
                        <p className='font-medium leading-tight text-m mt-2 mr-2 mb-2 border-l-4 pl-4 text-zinc-600' href="https://docs.google.com/document/d/1eDYSmdQ1mk26TYgQa8wtxAfeu77ZFJJS7wr-kB5ctbw/edit?usp=sharing">Metrics Model Plan</p>
                    </div>
                    <div>
                        <p className="font-medium leading-tight text-m mt-2 mr-2 mb-2 border-l-4 pl-4 text-zinc-600">Backend Metrics Model</p>
                    </div>
                    <div>
                        <p className='font-medium leading-tight text-m mt-2 mr-2 mb-2 border-l-4 pl-4 text-zinc-600'>Functioning Metrics Menu</p>
                    </div>
                </div>
            </div>
        </div>
