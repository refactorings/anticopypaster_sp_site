...
function Team() {
    return (
        <div className="m-4 p-4 items-center flex-col flex-grow">
            <h3 className="font-medium text-2xl mt-2 mb-8 text-zinc-600 ">Meet the Team!</h3>

            {/* TEAM INFORMATION */}
            <div className='m-2'>
                <div className='m-2'>
                    <h4 className="font-medium leading-tight text-xl text-zinc-600 ">Project Coach:</h4>
                    <p className="text-m m-2 mb-8 border-l-4 pl-4 text-zinc-600"><b className='text-zinc-600'>Xueling Zhang: </b><a href="mailto: Xueling.Zhang@rit.edu">Xueling.Zhang@rit.edu</a></p>
                </div>
            </div>
            ...
            <div className='m-2'>
                ...
                <div className='m-4'>
                    ...
                    <p className="text-s m-2 border-l-4 pl-4 text-zinc-600">Hey everybody, I'm Trey Pachucki and I'm the tech lead of our senior project team. For our team (as of right now) this consists of researching into what makes this plugin tick, as well as how IntelliJ plugins work in general. I have also previously worked at Paychex, as well as Waygate Technologies and don't have any set in stone plans for post-college yet aside from staying in the Rochester area. I'm hype to work with all of you</p>
                </div>
                <div className='m-4'>
                    <p className="text-m m-2"><b className='text-zinc-600'>Tyler Pauly: </b> <i>SCRUM Manager</i> <a href="mailto: tap5136@rit.edu">tap5136@rit.edu</a></p>
